...
STUDENT ACTIVITY
	...
	5.	Combining character sets can create sequences of matches.
		...
		Answer: matches 1 or more letters at the beginning, and 1 number at the end -
...
*/
	...
	var emailRegEx = /(\w[-._\w]*\w@\w[-._\w]*\.\w{2,3})/;
	...
	var clean = str.replace(/(\w[-._\w]*\w@\w[-._\w]*\.\w{2,3})/g, "XXX@XXX.com");
	console.log(clean);

	var clean = clean.replace(email, "jc@gmail.com");
	console.log(clean);

	var clean = clean.replace(/(\w[-._\w]*\w@\w[-._\w]*\.\w{2,3})/g, "jc@gmail.com");
	console.log(clean);

	console.log(str.match(email));

	console.log(str.match(/(\w[-._\w]*\w@\w[-._\w]*\.\w{2,3})/g));
