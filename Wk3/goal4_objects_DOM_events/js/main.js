/*
 ...
 Comments: "Goal 4: Course Material 4"
...
// 	by using their name as a string - all of the below are valid:
	...
	console.log(fsStudent['age']);	//Index syntax
...
// this is integrating multiple data types - object with an array of objects
	...
	console.log("James Bond's GPA:",obj1.students[2].GPA);			//Dot notation
	console.log("James Bond's GPA:",obj1['students'][2]['GPA']);	//Index notation
...
console.log('------------ querySelectorAll -------------------');
	...
	var nav = document.querySelectorAll('#nav li:last-child'); //Used Filter
	console.log(nav);
